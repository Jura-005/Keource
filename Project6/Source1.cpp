...
//	SDL_Color back_color = { 255,0,0 };
//	SDL_Rect rect2 = { ball->x + 13,ball->y + 6, ball->w / 2, ball->h / 2 };
...
//	TTF_Init();
//	TTF_Font* my_font = TTF_OpenFont("Text.ttf", 100);
//	SDL_Color fore_color = { 255,140,50 };
...
//			
//				GenerateCircle(&ball[j], centreRect, renderer, countRect);
//
//			}
//	
//		k2 = k;
